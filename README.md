...
* 🗄️ Passionate about **SQL, Databases, Database Design, and Data Modeling**
* 💻 Building my backend development skills with **C# and .NET**
* 🌱 Currently learning **ASP.NET Core Web API, Entity Framework Core, and LINQ**
...
* Applied **feature extraction and fine-tuning** to improve image classification performance.
* Developed an **LSTM-based NLP model** for classifying food-related user questions into different intents.
...
<img src="https://streak-stats.demolab.com/?user=Rawda-Hafez&theme=radical&hide_border=true" height="170" />
